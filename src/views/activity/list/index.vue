<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.title" placeholder="活动主题" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
      &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
      <el-input v-model="listQuery.type" placeholder="申请人" clearable class="filter-item" style="width: 130px"></el-input>
      &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
    ...
    <el-table
      ...
      <el-table-column label="活动主题" width="250px" align="center">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      <el-form ref="dataForm" :rules="rules" :model="temp"  label-position="left" label-width="80px" style="width: 400px; margin-left:50px;">
        <el-form-item label="活动主题" prop="assName">
        ...
        <el-form-item label="申请人" prop="createUser">
          <span>{{ temp.applyUser}}</span>
        </el-form-item>
        <el-form-item label="申请时间">
          <span>{{ temp.applyDate}}</span>
        </el-form-item>
        <el-form-item label=活动附件 v-if="temp.fileUrl!=null">
          <el-link type="success" :href="temp.fileUrl">下载附件</el-link>
        </el-form-item>
...
import {getActivityList,deleteActivityById,auditActivity,getPassActivityList} from "@/api/activity";
...
export default {
  ...
  methods: {
    getList() {
      ...
      getPassActivityList(this.listQuery).then(response => {
    ...
    handleDelete(row, index) {
      this.$confirm('此操作将永久删除该记录, 是否继续?', '提示', {
        ...
        deleteActivityById(row.id).then(response => {
          this.getList()
          this.$notify({
            title: 'Success',
