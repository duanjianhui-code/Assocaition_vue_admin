<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.submitUser" placeholder="名字" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
      &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
    ...
    <el-table
      ...
      <el-table-column label=分数 class-name="status-col" width="150">
        <template slot-scope="{row}">
          <el-tag type="success">
            {{row.score}}
          </el-tag>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      <el-form ref="dataForm" :rules="rules" :model="temp"  label-position="left" label-width="80px" style="width: 400px; margin-left:50px;">
        <el-form-item label="姓名" prop="assName">
          <span>{{ temp.submitUser}}</span>
        </el-form-item>
        <el-form-item label="提交时间" prop="introduction">
          <span>{{ temp.submitTime}}</span>
        </el-form-item>
        <el-form-item label="内容" prop="createUser">
          <span>{{ temp.contentJson}}</span>
        </el-form-item>
        <el-form-item label="分数" prop="createUser">
          <el-tag type="success">
            {{temp.score}}
          </el-tag>
        </el-form-item>
...
import {auditExamine, getExamineList,deleteExamineById,getPassExamineList} from "@/api/examine";
...
export default {
  ...
  methods: {
    getList() {
      ...
      getPassExamineList(this.listQuery).then(response => {
    ...
    handleDelete(row, index) {
      this.$confirm('此操作将永久删除该记录, 是否继续?', '提示', {
        ...
        deleteExamineById(row.id).then(response => {
          // this.getList()
          this.$notify({
            title: 'Success',
